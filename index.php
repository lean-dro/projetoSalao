...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item hover-underline-animation"><a class="nav-link" href="pagProdutos.php" target="_blank">SERVIÇOS</a></li>
                    <li class="nav-item hover-underline-animation"><a class="nav-link" target="_blank" href="pagProdutos.php">PRODUTOS</a></li>
    ...
    <div class="container-conteudo">
                ...
                <div id="carouselExampleCaptions" class="carousel slide " data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner ">
                        <div class="carousel-item active ">
                            <img src="images/carossel1.png" class="d-block w-50  mx-auto img-fluid rounded-2 col-lg-12 col-md-12" alt="...">
                            <div class="bg-carousel  float-start col-lg-4 col-lg-12 rounded-3 mt-2">
                                <h5 class="text-white  fw-bold fs-4">HAIR STYLIST</h5>
                                <p class="text-white  fw-bolder">Corte, mechas, luzes, técnicas de alisamento e coloração. Oferecemos a orientação necessária para resultados do seu agrado.</p>
                            </div>
                        ...
                        <?php foreach ($listaServico as $linha) { ?>
                            ...
                            <div class="carousel-item">
                                <img src=<?php echo str_replace("../../", " ", $linha['fotoServico']); ?> class="d-block w-50  mx-auto img-fluid rounded-2 col-lg-12 col-md-12" alt="...">
                                <div class="bg-carousel  float-start col-lg-4 col-lg-12 rounded-3 mt-2">
                                    <h5 class="text-white  fs-4 fw-bold"><?php echo $linha['descServico']; ?></h5>
                                    <p class="text-white fs-6 fw-bolder"><?php echo $linha['textoServico']; ?></p>
                                </div>
               ...
               <div class="col-lg-12 col-md-12 " style="padding-top: 110px;">
                   <div style="width: 140px; height: 3px; background: #03989E; margin-bottom: 15px; margin-left: 5px"></div>
                       ...
                       <div class="row g-1 row-cols-3">
                           ...
                           <div class="col">
                               <div class="p-1">
                                   <img class="img-fluid" src="images/galeria/galeria-2.jpg">
                               </div>
                           </div>
                           <div class="col">
                               <div class="p-1">
        ...
        </div> <!-- fim do container-galeria -->
         <!-- fim do container-conteudo -->
