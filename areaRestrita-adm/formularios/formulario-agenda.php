...
<body>
  ...
  <div class="container">
    <a href="../index-ar.php"><img class="img-fluid mx-auto d-block" src="../images-arearestrita/logo-shortcut.png"
        width="100px"></a>
    <div class="dashboard row">
      <div class="float-start col-lg-6 col-md-12 col-sm-12">
        <form style="margin-top: -14%; width: 50%;margin-left: 25%;" action="../cadastros/cadastrar-agendamento.php"
          method="POST">
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <th scope="row">
              <?php echo $linha['idAgenda']; ?>
            </th>
            <td>
              <?php echo $linha['dataAgenda']; ?>
            </td>
            <td>
              <?php echo $linha['horaAgenda']; ?>
            </td>
            <td>
  ...
  <div class="collapse" id="collapseExample">
    ...
    <div class="position-fixed bottom-0 end-0 p-3 me-3 formularioTab rounded-2 shadow border border-3"
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="idAgenda" <?php echo "id=idAgendaUp" ?> required>
  ...
  <div class="collapse" id="collapseExample2">
    <div class="position-fixed bottom-0 end-0 p-3 me-3 formularioTab rounded-2 shadow border border-3"
      ...
      <div class="mb-3">
        <label class="form-label">ID:</label>
        <input type="text" class="form-control" name="idAgenda" id="idAgendaDel" required>
